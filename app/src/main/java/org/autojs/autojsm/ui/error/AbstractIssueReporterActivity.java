package org.autojs.autojsm.ui.error;
...
public abstract class AbstractIssueReporterActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(org.autojs.autojsm.R.layout.air_activity_issue_reporter);
        findViews();
    ...
    private void initViews() {
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle(org.autojs.autojsm.R.string.text_issue_report);
        }
    ...
    public void finish() {
        if (mCrash) {
            if (!mReportFailed) {
                Toast.makeText(this, org.autojs.autojsm.R.string.text_report_succeed, Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(this, org.autojs.autojsm.R.string.text_report_fail, Toast.LENGTH_SHORT).show();
            }
            finishAffinity();
        } else {
            super.finish();
