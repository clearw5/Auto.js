...
import org.autojs.autojsm.ui.floating.CircularMenu;
import org.autojs.autojsm.ui.floating.FloatyWindowManger;
import org.autojs.autojsm.network.NodeBB;
import org.autojs.autojsm.network.VersionService;
import org.autojs.autojsm.network.api.UserApi;
import org.autojs.autojsm.network.entity.user.User;
import org.autojs.autojsm.network.entity.VersionInfo;
import org.autojs.autojsm.tool.SimpleObserver;
import org.autojs.autojsm.ui.main.MainActivity;
import org.autojs.autojsm.ui.main.community.CommunityFragment;
import org.autojs.autojsm.ui.user.LoginActivity_;
import org.autojs.autojsm.ui.settings.SettingsActivity;
import org.autojs.autojsm.ui.update.UpdateInfoDialogBuilder;
import org.autojs.autojsm.ui.user.WebActivity;
import org.autojs.autojsm.ui.user.WebActivity_;
import org.autojs.autojsm.ui.widget.AvatarView;

import com.stardust.theme.ThemeColorManager;

import org.autojs.autojsm.theme.ThemeColorManagerCompat;
...
import org.autojs.autojsm.tool.WifiTool;
...
import org.autojs.autojsm.ui.widget.BackgroundTarget;
...
//                mCheckForUpdatesItem
    ...
    void toggleWorkProvider(DrawerMenuItemViewHolder holder) {
        boolean enabled = holder.getSwitchCompat().isChecked();
        Log.d("switch-work-provider", "切换任务调度模式: " + (enabled ? "android-job" : "work-manager"));
        // TODO 转换所有任务, 目前移除所有任务
        if (enabled) {
            WorkManagerProvider.getInstance(getContext()).cancelAllWorks();
        } else {
            AndroidJobProvider.getInstance(getContext()).cancelAllWorks();
        }
